...
public:
    ...
    class spell_midsummer_torch_target_picker_SpellScript : public SpellScript
    {
        ...
        void Register() override
        {
            OnEffectHitTarget.Register(&spell_midsummer_torch_target_picker_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };
...
class spell_midsummer_torch_toss_land : public SpellScriptLoader
{
public:
    spell_midsummer_torch_toss_land() : SpellScriptLoader("spell_midsummer_torch_toss_land") { }

    class spell_midsummer_torch_toss_land_SpellScript : public SpellScript
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
        ...
        void Register() override
        {
            OnEffectHitTarget.Register(&spell_midsummer_torch_toss_land_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_midsummer_torch_toss_land_SpellScript();
    }
};
...
class spell_midsummer_test_ribbon_pole_channel : public SpellScriptLoader
{
public:
    spell_midsummer_test_ribbon_pole_channel() : SpellScriptLoader("spell_midsummer_test_ribbon_pole_channel") { }

    class spell_midsummer_test_ribbon_pole_channel_AuraScript : public AuraScript
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
            return ValidateSpellInfo(
        ...
        void Register() override
        {
            AfterEffectRemove.Register(&spell_midsummer_test_ribbon_pole_channel_AuraScript::HandleRemove, EFFECT_1, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            OnEffectPeriodic.Register(&spell_midsummer_test_ribbon_pole_channel_AuraScript::PeriodicTick, EFFECT_1, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_midsummer_test_ribbon_pole_channel_AuraScript();
    }
};

// 45406 - Holiday - Midsummer, Ribbon Pole Periodic Visual
class spell_midsummer_ribbon_pole_periodic_visual : public SpellScriptLoader
{
public:
    spell_midsummer_ribbon_pole_periodic_visual() : SpellScriptLoader("spell_midsummer_ribbon_pole_periodic_visual") { }

    class spell_midsummer_ribbon_pole_periodic_visual_AuraScript : public AuraScript
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
            return ValidateSpellInfo(
        ...
        void Register() override
        {
            OnEffectPeriodic.Register(&spell_midsummer_ribbon_pole_periodic_visual_AuraScript::PeriodicTick, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_midsummer_ribbon_pole_periodic_visual_AuraScript();
    }
};
...
// 45819 - Throw Torch
class spell_midsummer_juggle_torch : public SpellScriptLoader
{
public:
    spell_midsummer_juggle_torch() : SpellScriptLoader("spell_midsummer_juggle_torch") { }

    class spell_midsummer_juggle_torch_SpellScript : public SpellScript
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
            return ValidateSpellInfo({
        ...
        void Register() override
        {
            OnEffectHit.Register(&spell_midsummer_juggle_torch_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_midsummer_juggle_torch_SpellScript();
    }
};

// 45644 - Juggle Torch (Catch)
class spell_midsummer_torch_catch : public SpellScriptLoader
{
public:
    spell_midsummer_torch_catch() : SpellScriptLoader("spell_midsummer_torch_catch") { }

    class spell_midsummer_torch_catch_SpellScript : public SpellScript
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
        ...
        void Register() override
        {
            OnEffectHitTarget.Register(&spell_midsummer_torch_catch_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_midsummer_torch_catch_SpellScript();
    }
};
...
public:
    ...
    class spell_midsummer_fling_torch_SpellScript : public SpellScript
    {
        ...
        void Register() override
        {
            OnEffectHit.Register(&spell_midsummer_fling_torch_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };
...
// 45669 - Fling Torch
class spell_midsummer_fling_torch_triggered : public SpellScriptLoader
{
public:
    spell_midsummer_fling_torch_triggered() : SpellScriptLoader("spell_midsummer_fling_torch_triggered") { }

    class spell_midsummer_fling_torch_triggered_SpellScript : public SpellScript
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
        ...
        void Register() override
        {
            OnEffectHit.Register(&spell_midsummer_fling_torch_triggered_SpellScript::HandleTriggerMissile, EFFECT_0, SPELL_EFFECT_TRIGGER_MISSILE);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_midsummer_fling_torch_triggered_SpellScript();
    }
};

// 45671 - Juggle Torch (Catch, Quest)
class spell_midsummer_fling_torch_catch : public SpellScriptLoader
{
public:
    spell_midsummer_fling_torch_catch() : SpellScriptLoader("spell_midsummer_fling_torch_catch") { }

    class spell_midsummer_fling_torch_catch_SpellScript : public SpellScript
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
            return ValidateSpellInfo({
        ...
        void Register() override
        {
            OnEffectHitTarget.Register(&spell_midsummer_fling_torch_catch_SpellScript::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_midsummer_fling_torch_catch_SpellScript();
    }
};

// 45676 - Juggle Torch (Quest, Missed)
class spell_midsummer_fling_torch_missed : public SpellScriptLoader
{
public:
    spell_midsummer_fling_torch_missed() : SpellScriptLoader("spell_midsummer_fling_torch_missed") { }

    class spell_midsummer_fling_torch_missed_SpellScript : public SpellScript
    {
        ...
        void Register() override
        {
            OnObjectAreaTargetSelect.Register(&spell_midsummer_fling_torch_missed_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_DEST_AREA_ENTRY);
            OnObjectAreaTargetSelect.Register(&spell_midsummer_fling_torch_missed_SpellScript::FilterTargets, EFFECT_2, TARGET_UNIT_DEST_AREA_ENTRY);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_midsummer_fling_torch_missed_SpellScript();
    }
};
...
void AddSC_event_midsummer()
{
    ...
    new spell_midsummer_torch_toss_land();
    new spell_midsummer_test_ribbon_pole_channel();
    new spell_midsummer_ribbon_pole_periodic_visual();
    new spell_midsummer_juggle_torch();
    new spell_midsummer_torch_catch();
    new spell_midsummer_fling_torch();
    new spell_midsummer_fling_torch_triggered();
    new spell_midsummer_fling_torch_catch();
    new spell_midsummer_fling_torch_missed();
}
