...
public:
    ...
    private:
        ...
        void SummonNPC(GameObject* go, Player* player, uint32 npc, uint32 spell)
        {
            ...
            player->SummonCreature(npc, go->GetPositionX(), go->GetPositionY(), go->GetPositionZ(), player->GetOrientation() - float(M_PI), TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 300000);
