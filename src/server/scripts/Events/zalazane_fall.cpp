...
public:
    ...
    struct npc_tiger_matriarch_credit_AI : public ScriptedAI
    {
        npc_tiger_matriarch_credit_AI(Creature* creature) : ScriptedAI(creature)
        {
    ...
    {
        return new npc_tiger_matriarch_credit_AI(creature);
    }
};
...
public:
    ...
    struct npc_tiger_matriarch_AI : public ScriptedAI
    {
        npc_tiger_matriarch_AI(Creature* creature) : ScriptedAI(creature)
        {
        }
        ...
        void IsSummonedBy(Unit* summonerUnit) override
        {
            Player* summoner = summonerUnit->ToPlayer();
    ...
    CreatureAI* GetAI(Creature* creature) const override
    {
        return new npc_tiger_matriarch_AI(creature);
    }
};
...
public:
    ...
    struct npc_troll_volunteer_AI : public ScriptedAI
    {
        npc_troll_volunteer_AI(Creature* creature) : ScriptedAI(creature)
        {
            _mountModel = 0;
            _complete = false;
        }
        ...
        void InitializeAI() override
        {
            ...
            if (Player* player = me->GetOwner()->ToPlayer())
                me->GetMotionMaster()->MoveFollow(player, 5.0f, static_cast<float>(rand_norm() + 1.0f) * static_cast<float>(M_PI) / 3.0f * 4.0f);
        }
    ...
    CreatureAI* GetAI(Creature* creature) const override
    {
        return new npc_troll_volunteer_AI(creature);
    }
};

typedef npc_troll_volunteer::npc_troll_volunteer_AI VolunteerAI;
...
public:
    ...
    class spell_mount_check_AuraScript : public AuraScript
    {
        ...
        {
            OnEffectPeriodic.Register(&spell_mount_check_AuraScript::HandleEffectPeriodic, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
        }
    };
...
public:
    ...
    class spell_voljin_war_drums_SpellScript : public SpellScript
    {
        ...
        void Register() override
        {
            OnEffectHitTarget.Register(&spell_voljin_war_drums_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };
