...
public:
    ...
    struct npc_lord_gregor_lescovarAI : public EscortAI
    {
        ...
        //TO-DO: We don't have movemaps, also we can't make 2 npcs walks to one point properly (and we can not use escort ai, because they are 2 different spawns and with same entry), because of it we make them, disappear.
