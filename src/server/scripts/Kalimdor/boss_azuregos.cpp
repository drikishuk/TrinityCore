...
public:
    ...
    struct boss_azuregos_AI : public WorldBossAI
    {
        boss_azuregos_AI(Creature* creature) : WorldBossAI(creature)
        {
            _enraged = false;
        }
    ...
    {
        return new boss_azuregos_AI(creature);
    }
};
...
public:
    ...
    class spell_mark_of_frost_SpellScript : public SpellScript
    {
        ...
        {
            OnObjectAreaTargetSelect.Register(&spell_mark_of_frost_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
            OnEffectHitTarget.Register(&spell_mark_of_frost_SpellScript::HandleEffect, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
        }
    };
