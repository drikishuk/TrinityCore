...
class spell_winter_veil_reindeer_transformation : public SpellScriptLoader
{
public:
    spell_winter_veil_reindeer_transformation() : SpellScriptLoader("spell_winter_veil_reindeer_transformation") { }

    class spell_winter_veil_reindeer_transformation_SpellScript : public SpellScript
    {
        bool Validate(SpellInfo const* /*spell*/) override
        {
            return ValidateSpellInfo(
        ...
        void Register() override
        {
            OnEffectHit.Register(&spell_winter_veil_reindeer_transformation_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_winter_veil_reindeer_transformation_SpellScript();
    }
};
...
void AddSC_event_winter_veil()
{
    ...
    new spell_winter_veil_reindeer_transformation();
}
