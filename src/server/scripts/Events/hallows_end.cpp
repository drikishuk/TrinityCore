...
public:
    ...
    class spell_hallow_end_candy_pirate_AuraScript: public AuraScript
    {
        ...
        {
            uint32 spell = static_cast<Gender>(GetTarget()->getGender()) == GENDER_FEMALE ? SPELL_HALLOWS_END_CANDY_FEMALE_DEFIAS_PIRATE : SPELL_HALLOWS_END_CANDY_MALE_DEFIAS_PIRATE;
...
public:
    ...
    class spell_hallow_end_trick_SpellScript : public SpellScript
    {
        ...
        void HandleScript(SpellEffIndex /*effIndex*/)
        {
            ...
            {
                uint8 gender = static_cast<Gender>(target->getGender());
