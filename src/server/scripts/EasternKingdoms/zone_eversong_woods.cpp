...
class npc_partygoer_pather : public CreatureScript
{
public:
    npc_partygoer_pather() : CreatureScript("npc_partygoer_pather") { }

    struct npc_partygoer_pather_AI : public ScriptedAI
    {
        npc_partygoer_pather_AI(Creature* creature) : ScriptedAI(creature), _path(PATH_FIRST_PATH) { }
    ...
    {
        return new npc_partygoer_pather_AI(creature);
    }
};
...
public:
    ...
    struct npc_partygoer_AI : public ScriptedAI
    {
        npc_partygoer_AI(Creature* creature) : ScriptedAI(creature), _facing(0.0f) { }
    ...
    CreatureAI* GetAI(Creature* creature) const override
    {
        return new npc_partygoer_AI(creature);
    }
};

void AddSC_eversong_woods()
{
    new npc_partygoer_pather();
    new npc_partygoer();
}
