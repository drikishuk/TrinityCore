...
class spell_operation_gnomeregan_basic_orders_emote : public SpellScriptLoader
{
public:
    spell_operation_gnomeregan_basic_orders_emote() : SpellScriptLoader("spell_operation_gnomeregan_basic_orders_emote") { }

    class spell_operation_gnomeregan_basic_orders_emote_AuraScript : public AuraScript
    {
        ...
        {
            OnEffectPeriodic.Register(&spell_operation_gnomeregan_basic_orders_emote_AuraScript::HandlePeriodic, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_operation_gnomeregan_basic_orders_emote_AuraScript();
    }
};

void AddSC_event_operation_gnomeregan()
{
    new spell_operation_gnomeregan_basic_orders_emote();
}
