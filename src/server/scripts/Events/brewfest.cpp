...
public:
    ...
    class spell_brewfest_giddyup_AuraScript : public AuraScript
    {
        void OnChange(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
        {
            ...
            if (GetTargetApplication()->GetRemoveMode() == AuraRemoveFlags::ByDefault)
            {
                target->RemoveAura(SPELL_RAM_TROT);
...
public:
    ...
    class spell_brewfest_dismount_ram_SpellScript : public SpellScript
    {
        ...
        void Register() override
        {
            OnEffectHitTarget.Register(&spell_brewfest_dismount_ram_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_brewfest_dismount_ram_SpellScript();
    }
};
...
class spell_brewfest_mount_transformation : public SpellScriptLoader
{
public:
    spell_brewfest_mount_transformation() : SpellScriptLoader("spell_brewfest_mount_transformation") { }

    class spell_brewfest_mount_transformation_SpellScript : public SpellScript
    {
        ...
        void Register() override
        {
            OnEffectHit.Register(&spell_brewfest_mount_transformation_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_brewfest_mount_transformation_SpellScript();
    }
};
...
class spell_brewfest_botm_the_beast_within : public SpellScriptLoader
{
public:
    spell_brewfest_botm_the_beast_within() : SpellScriptLoader("spell_brewfest_botm_the_beast_within") { }

    class spell_brewfest_botm_the_beast_within_AuraScript : public AuraScript
    {
        ...
        void Register() override
        {
            AfterEffectRemove.Register(&spell_brewfest_botm_the_beast_within_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_brewfest_botm_the_beast_within_AuraScript();
    }
};
...
// 49864 - Gassy
class spell_brewfest_botm_gassy : public SpellScriptLoader
{
public:
    spell_brewfest_botm_gassy() : SpellScriptLoader("spell_brewfest_botm_gassy") { }

    class spell_brewfest_botm_gassy_AuraScript : public AuraScript
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
        ...
        void Register() override
        {
            AfterEffectRemove.Register(&spell_brewfest_botm_gassy_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_brewfest_botm_gassy_AuraScript();
    }
};
...
// 49822 - Bloated
class spell_brewfest_botm_bloated : public SpellScriptLoader
{
public:
    spell_brewfest_botm_bloated() : SpellScriptLoader("spell_brewfest_botm_bloated") { }

    class spell_brewfest_botm_bloated_AuraScript : public AuraScript
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
        ...
        void Register() override
        {
            AfterEffectRemove.Register(&spell_brewfest_botm_bloated_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_brewfest_botm_bloated_AuraScript();
    }
};
...
class spell_brewfest_botm_internal_combustion : public SpellScriptLoader
{
public:
    spell_brewfest_botm_internal_combustion() : SpellScriptLoader("spell_brewfest_botm_internal_combustion") { }

    class spell_brewfest_botm_internal_combustion_AuraScript : public AuraScript
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
        ...
        void Register() override
        {
            AfterEffectRemove.Register(&spell_brewfest_botm_internal_combustion_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_brewfest_botm_internal_combustion_AuraScript();
    }
};
...
class spell_brewfest_botm_jungle_madness : public SpellScriptLoader
{
public:
    spell_brewfest_botm_jungle_madness() : SpellScriptLoader("spell_brewfest_botm_jungle_madness") { }

    class spell_brewfest_botm_jungle_madness_SpellScript : public SpellScript
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
        ...
        void Register() override
        {
            AfterCast.Register(&spell_brewfest_botm_jungle_madness_SpellScript::HandleAfterCast);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_brewfest_botm_jungle_madness_SpellScript();
    }
};
...
class spell_brewfest_botm_teach_language : public SpellScriptLoader
{
public:
    spell_brewfest_botm_teach_language() : SpellScriptLoader("spell_brewfest_botm_teach_language") { }

    class spell_brewfest_botm_teach_language_SpellScript: public SpellScript
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
        ...
        void Register() override
        {
            OnEffectHit.Register(&spell_brewfest_botm_teach_language_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_brewfest_botm_teach_language_SpellScript();
    }
};
...
class spell_brewfest_botm_weak_alcohol : public SpellScriptLoader
{
public:
    spell_brewfest_botm_weak_alcohol() : SpellScriptLoader("spell_brewfest_botm_weak_alcohol") { }

    class spell_brewfest_botm_weak_alcohol_SpellScript : public SpellScript
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
        ...
        void Register() override
        {
            AfterCast.Register(&spell_brewfest_botm_weak_alcohol_SpellScript::HandleAfterCast);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_brewfest_botm_weak_alcohol_SpellScript();
    }
};
...
class spell_brewfest_botm_empty_bottle_throw_resolve : public SpellScriptLoader
{
public:
    spell_brewfest_botm_empty_bottle_throw_resolve() : SpellScriptLoader("spell_brewfest_botm_empty_bottle_throw_resolve") { }

    class spell_brewfest_botm_empty_bottle_throw_resolve_SpellScript : public SpellScript
    {
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
            return ValidateSpellInfo(
        ...
        void Register() override
        {
            OnEffectHitTarget.Register(&spell_brewfest_botm_empty_bottle_throw_resolve_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_brewfest_botm_empty_bottle_throw_resolve_SpellScript();
    }
};
...
void AddSC_event_brewfest()
{
    ...
    new spell_brewfest_mount_transformation();
    new spell_brewfest_botm_the_beast_within();
    new spell_brewfest_botm_gassy();
    new spell_brewfest_botm_bloated();
    new spell_brewfest_botm_internal_combustion();
    new spell_brewfest_botm_jungle_madness();
    new spell_brewfest_botm_teach_language();
    new spell_brewfest_botm_weak_alcohol();
    new spell_brewfest_botm_empty_bottle_throw_resolve();
}
