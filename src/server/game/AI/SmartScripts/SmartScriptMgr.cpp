...
bool SmartAIMgr::CheckUnusedEventParams(SmartScriptHolder const& e)
{
    size_t paramsStructSize = [&]() -> size_t
        ...
        for (size_t index = paramsCount; index < rawCount; index++)
        {
            ...
            if (value != 0)
            {
                TC_LOG_WARN("sql.sql", "SmartAIMgr: Entry %d SourceType %u Event %u Action %u has unused event_param%u with value %u, it should be 0.",
    ...
    size_t paramsStructSize = [&]() -> size_t
        {
            ...
            case SMART_ACTION_ADD_NPC_FLAG: return sizeof(SmartAction::addUnitFlag);
            case SMART_ACTION_REMOVE_NPC_FLAG: return sizeof(SmartAction::removeUnitFlag);
            case SMART_ACTION_SIMPLE_TALK: return sizeof(SmartAction::talk /*simpleTalk*/);
            ...
            case SMART_ACTION_CALL_RANDOM_RANGE_TIMED_ACTIONLIST: return sizeof(SmartAction::randTimedActionList /*randRangeTimedActionList*/);
            ...
            case SMART_ACTION_ADD_THREAT: return sizeof(SmartAction::threatPCT /*threat*/);
    ...
    size_t paramsStructSize = [&]() -> size_t
        {
            ...
            case SMART_TARGET_CLOSEST_CREATURE: return sizeof(SmartTarget::closest);
            case SMART_TARGET_CLOSEST_GAMEOBJECT: return sizeof(SmartTarget::closest);
            ...
            case SMART_TARGET_CLOSEST_UNSPAWNED_GAMEOBJECT: return sizeof(SmartTarget::closest);
            default:
