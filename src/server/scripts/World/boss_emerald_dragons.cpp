...
public:
    ...
    class spell_dream_fog_sleep_SpellScript : public SpellScript
    {
        ...
        {
            OnObjectAreaTargetSelect.Register(&spell_dream_fog_sleep_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_DEST_AREA_ENEMY);
        }
    };
...
public:
    ...
    class spell_mark_of_nature_SpellScript : public SpellScript
    {
        ...
        void Register() override
        {
            OnObjectAreaTargetSelect.Register(&spell_mark_of_nature_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
            OnEffectHitTarget.Register(&spell_mark_of_nature_SpellScript::HandleEffect, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
        }
    };
